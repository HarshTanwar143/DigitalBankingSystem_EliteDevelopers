...
public class TransactionService : ITransactionService
{
    ...
    public async Task<TransferResultDto> TransferAsync(int userId, TransferRequestDto request)
    {
        ...
        if (string.IsNullOrWhiteSpace(toAccountNumber))
            return new TransferResultDto { Success = false, Message = "Destination account number is required." };
        ...
        var toAccount = await _repo.GetAccountByNumberAsync(toAccountNumber);
