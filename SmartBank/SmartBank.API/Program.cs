...
// ─── FluentValidation ─────────────────────────────────────────────────────────
// Automatically validates incoming request DTOs before the action method runs.
// Returns 400 ValidationProblemDetails if any rule fails – no manual ModelState checks needed.
